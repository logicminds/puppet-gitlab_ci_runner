  ...
  Vagrant.configure('2') do |conf|
    ...
    conf.vm.define hostname.to_sym do |mod|
      ...
      if os_type == :windows
        ...
        mod.vm.provision :shell, :inline => "/opt/puppet/bin/puppet apply --parser=future --basemodulepath='/etc/puppet/modules:/tmp/puppet/modules' --verbose /etc/puppet/modules/#{module_name}/tests/#{manifest}"
